...
//			data.getChessTable().clearTable();
			...
			data.getLocMap().clearIndex();
			rule.getChessRule().clearCnt();
...
//			data.getChessTable().getBlackKing().setVisible(false);
			...
			if (data.getGameStatus().getChessStatus().getWhichGame() == 1) {
				SaveData saveData = new SaveData(data.getGameStatus().getChessStatus().getWhichGame(), data.getGameStatus().getChessStatus().getWhichOrder(), data.getGameStatus().getChessRecord().getRecordStack(), data.getChessTable().getAllChineseChessData());
				save.saveGame(file, saveData);
			} else {
				SaveData saveData = new SaveData(data.getGameStatus().getChessStatus().getWhichGame(), data.getGameStatus().getChessStatus().getWhichOrder(), data.getGameStatus().getChessRecord().getRecordStack(), data.getChessTable().getAllTaiwanChessData());
				save.saveGame(file, saveData);
			}
			...
			if (data.getGameStatus().getChessStatus().getWhichOrder() == 0) {
				if (surrendP1Cnt < 1) {
					if (data.getGameStatus().getChessRecord().takeOneChess() != null) {
						...
						data.getChessTable().setAllChess(data.getGameStatus().getChessRecord().getListRecord().peek());
...
//				System.out.println(c.getName() + " " + c.isChessDead());
				int locX = data.getLocMap().getLocationMap()[c.getChessY()][c.getChessX()].getX();
				int locY = data.getLocMap().getLocationMap()[c.getChessY()][c.getChessX()].getY();
				c.setLocation(locX, locY);
			}
...
//					System.out.println("yuwegbnkwegioweioehwjwehojhjo false");
					c.setVisible(false);
				}
			}
		}
